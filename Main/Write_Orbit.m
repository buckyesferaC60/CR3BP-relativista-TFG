function Out = Write_Orbit(Orbit_struct,Orbit)
...
%   .ci
    ...
    Orbit_dir = strrep(strcat('Orbit_files','\',num2str(Orbit_struct.kappa,10),'\',num2str(Orbit_struct.mu,10),'\',Orbit_struct.family),'.','p'); 
